            ...
            <TableContainer component={Paper} sx={{ maxWidth: { xs: "100%", md: "60%" } }}>
                <Table>
                    ...
                    <TableBody>
                        ...
                        >
                            <TableCell sx={{ fontWeight: "bold", textAlign: "right" }}>₹{tablesList.bill_details[0].invoiceSubtotal}</TableCell>
                            <TableCell sx={{ fontWeight: "bold", textAlign: "right" }}>₹{tablesList.bill_details[1].invoiceTaxes}</TableCell>
                            <TableCell sx={{ fontWeight: "bold", textAlign: "right" }}>₹{tablesList.bill_details[2].invoiceTotal}</TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
            </TableContainer>
            <Box>
                <Typography>Is Waiter Saw the order: {' '}
                    <Typography
                        component="span"
                        sx={{
                    ...
                    >
                        {tablesList.waiter_confirm ? "Yes" : "Pending"}
                    </Typography>
                </Typography>
